    ...
    <Router>
      ...
      <main role="main" className="container-xl py-4 px-2">
        <Switch>
          ...
          <PrivateRoute
            path="/serviceshow/:category/:serviceId"
            component={ServiceShow}
          />
          <PrivateRoute
            path="/edit_service/:category/:id"
            component={EditService}
          />
          <PrivateRoute path="/tips/:id" component={TipsTricks} />
          <PrivateRoute
            path="/tiptrickshow/:category/:tipandtrickid"
            component={TipTrickShow}
          />
          <PrivateRoute
            path="/edit_tips/:category/:id"
            component={EditTipsTricks}
          />
          <PrivateRoute path="/claims" component={Claims} />
          <PrivateRoute path="/ratings/:type/:id" component={Ratings} />
          <PrivateRoute path="/settings" component={Settings} />
          <PrivateRoute
            path="/claimshow/:claimId/:serviceId/:userId"
            component={ClaimShow}
          />
